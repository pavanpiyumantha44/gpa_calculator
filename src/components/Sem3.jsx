                        ...
                        <table className='table'>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>2</td>
                              <td>
                                <select className='form-select' onChange={e=> setSem3({...sem3,HNDIT2301:(parseFloat(e.target.value)*2)})}>
                            ...
                            <tr>
                              ...
                              <td>2</td>
                              <td>
                                <select className='form-select' onChange={e=> setSem3({...sem3,HNDIT2302:(parseFloat(e.target.value)*2)})}>
                                  <option disabled selected>__Select__</option>
                                  <option value={4}>A+</option>
                                  <option value={4}>A</option>
                                  <option value={3.7}>A-</option>
                            ...
                            <tr>
                              ...
                              <td>2</td>
                              <td>
                                <select className='form-select' onChange={e=> setSem3({...sem3,HNDIT2303:(parseFloat(e.target.value)*2)})}>
                                  <option disabled selected>__Select__</option>
                                  <option value={4}>A+</option>
                                  <option value={4}>A</option>
                                  <option value={3.7}>A-</option>
                            ...
                            <tr>
                              ...
                              <td>4</td>
                              <td>
                                <select className='form-select' onChange={e=> setSem3({...sem3,HNDIT2304:(parseFloat(e.target.value)*4)})}>
                                  <option disabled selected>__Select__</option>
                                  <option value={4}>A+</option>
                                  <option value={4}>A</option>
                                  <option value={3.7}>A-</option>
                            ...
                            <tr>
                              ...
                              <td>2</td>
                              <td>
                                <select className='form-select' onChange={e=> setSem3({...sem3,HNDIT2305:(parseFloat(e.target.value)*2)})}>
                                  <option disabled selected>__Select__</option>
                                  <option value={4}>A+</option>
                                  <option value={4}>A</option>
                                  <option value={3.7}>A-</option>
                            ...
                            <tr>
                              ...
                              <td>3</td>
                              <td>
                                <select className='form-select' onChange={e=> setSem3({...sem3,HNDIT2310:(parseFloat(e.target.value)*3)})}>
                                  <option disabled selected>__Select__</option>
                                  <option value={4}>A+</option>
                                  <option value={4}>A</option>
                                  <option value={3.7}>A-</option>
                            ...
                            <tr>
                              ...
                              <td>2</td>
                              <td>
                                <select className='form-select' onChange={e=> setSem3({...sem3,HNDIT2311:(parseFloat(e.target.value)*2)})}>
                                  <option disabled selected>__Select__</option>
                                  <option value={4}>A+</option>
                                  <option value={4}>A</option>
                                  <option value={3.7}>A-</option>
                            ...
                            <tr>
                              ...
                              <td>3</td>
                              <td>
                                <select className='form-select' onChange={e=> setSem3({...sem3,HNDIT2312:(parseFloat(e.target.value)*3)})}>
                                  <option disabled selected>__Select__</option>
                                  <option value={4}>A+</option>
                                  <option value={4}>A</option>
                                  <option value={3.7}>A-</option>
