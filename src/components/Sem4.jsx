            ...
            <form onSubmit={handleSem4GPA}>
              <div className="card">
                <div className="card-header">
                  <h2 className="text-center">Semester IV</h2>
                </div>
                          ...
                          <td>
                            <select
                              ...
                              onChange={(e) =>
                                setSem4({
                                  ...sem4,
                                  HNDIT2401: parseFloat(e.target.value) * 2,
                                })
                              }
                            >
                          ...
                          <td>
                            <select
                              ...
                              onChange={(e) =>
                                setSem4({
                                  ...sem4,
                                  HNDIT2402: parseFloat(e.target.value) * 2,
                                })
                              }
                            >
                              <option disabled selected>
                          ...
                          <td>
                            <select
                              ...
                              onChange={(e) =>
                                setSem4({
                                  ...sem4,
                                  HNDIT2403: parseFloat(e.target.value) * 2,
                                })
                              }
                            >
                              <option disabled selected>
                          ...
                          <td>
                            <select
                              ...
                              onChange={(e) =>
                                setSem4({
                                  ...sem4,
                                  HNDIT2404: parseFloat(e.target.value) * 6,
                                })
                              }
                            >
                              <option disabled selected>
                          ...
                          <td>
                            <select
                              ...
                              onChange={(e) =>
                                setSem4({
                                  ...sem4,
                                  HNDIT2405: parseFloat(e.target.value) * 2,
                                })
                              }
                            >
                              <option disabled selected>
                          ...
                          <td>
                            <select
                              ...
                              onChange={(e) =>
                                setSem4({
                                  ...sem4,
                                  HNDIT2411: parseFloat(e.target.value) * 3,
                                })
                              }
                            >
                              <option disabled selected>
                          ...
                          <td>
                            <select
                              ...
                              onChange={(e) =>
                                setSem4({
                                  ...sem4,
                                  HNDIT2413: parseFloat(e.target.value) * 3,
                                })
                              }
                            >
                              <option disabled selected>
                          ...
                          <td>
                            <select
                              ...
                              onChange={(e) =>
                                setSem4({
                                  ...sem4,
                                  HNDIT2417: parseFloat(e.target.value) * 3,
                                })
                              }
                            >
                              <option disabled selected>
